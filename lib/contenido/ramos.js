...
export const ramos = [
  {
    icon: Flame,
    slug: 'incendio-y-lineas-aliadas',
  ...
  {
    icon: Building2,
    slug: 'todo-riesgo-propiedad-y-construccion',
...
/* Índice por slug, para las fichas de /ramos/[slug]. */
export const ramoPorSlug = Object.fromEntries(ramos.map((r) => [r.slug, r]))
