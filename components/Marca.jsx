 ...
 * Identidad ASSANCH.
 *
 * Los trazados salen del manual de marca oficial (LOGO ASSANCH.pdf), extraidos
 * del vector original y normalizados a los hex del manual: amarillo FFB600,
 * rojo E52421, negro 131B21.
 *
 * NO editar los atributos `d` a mano.
 *
 * El negro se emite como `currentColor`, asi la marca se invierte sola sobre
 * banda oscura sin necesitar un segundo archivo.
 */
...
export function LogoMarca({
  ...
  return (
    <svg viewBox="282.88 124.46 226.26 226.26" width={size} height={size}
      ...
      {/* Acentos de marca. `mono` los omite: en marcas de agua y
          placeholders el color compite con el fondo. */}
      {!mono && (
        <>
          <path d="M418.78 179.54 L396.11 179.54 L396.07 179.50 L396.03 179.54 L373.40 179.54 L390.39 162.51 C393.56 159.34 398.66 159.34 401.73 162.51 Z" fill="#FFB600" fillRule="nonzero" />
          <path d="M418.78 296.03 L401.73 313.14 C400.24 314.61 398.36 315.41 396.43 315.49 L395.65 315.49 C393.72 315.41 391.82 314.61 390.39 313.14 L373.30 296.03 L395.97 296.03 L396.07 296.13 L396.17 296.03 Z" fill="#E52421" fillRule="nonzero" />
        </>
      )}
    </svg>
  )
...
/* Relacion de aspecto del logotipo, medida sobre el vector original. */
...
export function LogoTipo({ height = 20, className = '', decorativo = false }) {
  return (
    ...
    >
      ...
      <path d="M332.12 395.46 C328.64 394.15 325.17 393.04 321.69 392.11 C318.21 391.19 315.27 390.09 312.84 388.81 C310.42 387.53 309.21 385.84 309.21 383.74 C309.21 380.49 311.66 378.86 316.57 378.86 C319.32 378.86 322.70 379.51 326.71 380.82 C330.73 382.13 334.50 383.80 338.00 385.84 L344.41 372.55 C336.82 367.57 328.02 365.08 318.01 365.08 C309.97 365.08 303.51 366.92 298.64 370.58 C293.76 374.25 291.32 379.15 291.32 385.27 C291.32 388.97 292.19 392.14 293.95 394.79 C295.70 397.44 297.88 399.37 300.50 400.58 C303.12 401.79 305.95 402.91 309.02 403.93 C312.08 404.95 314.91 405.76 317.53 406.36 C320.15 406.97 322.33 407.89 324.08 409.14 C325.84 410.38 326.71 411.93 326.71 413.78 C326.71 415.69 325.95 417.14 324.42 418.13 C322.89 419.12 320.75 419.61 318.01 419.61 C314.44 419.61 310.36 418.67 305.76 416.79 C301.17 414.91 297.18 412.50 293.80 409.57 L287.20 422.68 C291.22 425.99 295.94 428.61 301.36 430.52 C306.78 432.43 312.27 433.39 317.82 433.39 C325.60 433.39 332.01 431.59 337.05 427.99 C342.09 424.38 344.61 419.36 344.61 412.92 C344.61 408.45 343.39 404.75 340.97 401.82 C338.55 398.89 335.60 396.77 332.12 395.46" fill="currentColor" fillRule="nonzero" />
      <path d="M379.81 407.60 L389.56 382.81 L399.12 407.60 Z M398.85 365.81 L381.29 365.81 L352.41 432.77 L369.96 432.77 L374.79 420.51 L404.14 420.51 L408.88 432.77 L427.08 432.77 Z" fill="currentColor" fillRule="nonzero" />
      <path d="M484.93 407.18 L454.03 365.85 L439.01 365.85 L439.01 432.82 L454.99 432.82 L454.99 391.58 L485.79 432.82 L500.81 432.82 L500.81 365.85 L484.93 365.85 Z" fill="currentColor" fillRule="nonzero" />
      <path d="M560.36 416.55 C557.33 417.96 554.41 418.66 551.60 418.66 C546.31 418.66 541.87 416.78 538.30 413.01 C534.73 409.25 532.95 404.56 532.95 398.95 C532.95 393.47 534.73 388.86 538.30 385.12 C541.87 381.39 546.31 379.53 551.60 379.53 C554.60 379.53 557.61 380.31 560.64 381.87 C563.67 383.44 566.27 385.56 568.44 388.24 L578.29 376.56 C574.91 373.12 570.81 370.38 566.00 368.33 C561.18 366.30 556.29 365.27 551.31 365.27 C541.11 365.27 532.60 368.51 525.77 374.98 C518.94 381.46 515.53 389.51 515.53 399.14 C515.53 408.96 518.88 417.16 525.58 423.73 C532.28 430.30 540.66 433.58 550.74 433.58 C555.65 433.58 560.58 432.47 565.52 430.23 C570.46 428.00 574.75 425.04 578.39 421.34 L568.44 410.81 C566.08 413.24 563.38 415.15 560.36 416.55" fill="currentColor" fillRule="nonzero" />
      <path d="M636.65 365.85 L636.65 393.40 L608.90 393.40 L608.90 365.85 L591.87 365.85 L591.87 432.82 L608.90 432.82 L608.90 406.80 L636.65 406.80 L636.65 432.82 L653.68 432.82 L653.68 365.85 Z" fill="currentColor" fillRule="nonzero" />
    </svg>
  )
}

/**
 * Lockup horizontal para la barra de navegacion y el pie.
 *
 * El manual solo trae la version apilada (simbolo sobre texto), que a 26px de
 * alto queda ilegible en una barra. Aqui se recomponen las dos piezas
 * originales en horizontal, sin deformar ninguna.
 */
